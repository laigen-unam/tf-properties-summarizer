...
for t in TFs:
    ...
    if os.path.exists(os.path.join(options.classifiedPath, t)):
        print("g")
        with open(os.path.join(options.classifiedPath, t, options.feature + ".classified.txt")) as cFile, open(
                os.path.join(options.wordPath, t, t + "_concatenated.word.txt")) as wFile:
